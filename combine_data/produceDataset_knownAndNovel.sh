...
bash $HERE/filterCooccurrences_knownAndNovel.sh $outDir/validation.cooccurrences $outDir/training.ids $outDir/training.cooccurrences $outDir/validation.cooccurrences.tmp
mv $outDir/validation.cooccurrences.tmp $outDir/validation.cooccurrences

python $HERE/checkFilteredCooccurrences_knownAndNovel.py --cooccurrenceFile $outDir/validation.cooccurrences --acceptedIDs $outDir/training.ids
...
do
	...
	bash $HERE/filterCooccurrences_knownAndNovel.sh $outDir/testing.$testYear.cooccurrences.unfiltered $outDir/trainingAndValidation.ids $outDir/tracking.cooccurrences $outDir/testing.$testYear.cooccurrences

	python $HERE/checkFilteredCooccurrences_knownAndNovel.py --cooccurrenceFile $outDir/testing.$testYear.cooccurrences --acceptedIDs $outDir/trainingAndValidation.ids
