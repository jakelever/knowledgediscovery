...
python generateTestcases.py --$type --skeletonSentencesFile $skeletonSentences --wordlistFile $wordlist --outXML $goldXML  --outCooccurrences $goldCooccurrences --outExplanations $goldExplanations --addRandomCommandChars > $generationLog
